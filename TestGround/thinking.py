...
class think:
	...
	def __init__(self,start):
		...
		self.flags = []
		self.flags.append(Tools.OneFlag(start + 100,start + 170, "america", 462, 349))
		self.flags.append(Tools.OneFlag(start + 130,start + 200, "mexican", 826, 349))
