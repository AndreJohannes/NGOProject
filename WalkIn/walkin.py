...
for i in range(0,48):
	...
	base1.paste((0,256),(0, 0, 1280, 720), image.convert("RGBA"))
	base2.paste((0,256),(0, 0, 1280, 720), image.convert("RGBA"))
	color = max(0,min((15*(i-10)),256))
	image_mirror.paste((0,color),(0, 0, 1280, 720), image_mirror.convert("RGBA"));
	base1.paste((0,256),(100, 0, 1380, 720), image_mirror.convert("RGBA"))
