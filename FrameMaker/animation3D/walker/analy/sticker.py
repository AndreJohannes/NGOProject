...
class stickman:
	...
	def fromPoints(cls, dict , offset):
		...
		return cls((dict["crotch"][0] + offset[0], dict["crotch"][1] + offset[1]), orientation_leg1,orientation_lower_leg1, orientation_leg2, orientation_lower_leg2,
			orientation_arm1, orientation_lower_arm1, orientation_arm2, orientation_lower_arm2)
	...
	def getWeightedAverage(cls, stckman1, stckman2, w):
		...
		orientation_lower_leg1 = cls.weightedAverageOrientation(stckman1.orientation_lower_leg1,stckman2.orientation_lower_leg1,w)
		orientation_lower_leg2 = cls.weightedAverageOrientation(stckman1.orientation_lower_leg2,stckman2.orientation_lower_leg2,w)
		...
		orientation_lower_arm1 = cls.weightedAverageOrientation(stckman1.orientation_lower_arm1,stckman2.orientation_lower_arm1,w)
		orientation_lower_arm2 = cls.weightedAverageOrientation(stckman1.orientation_lower_arm2,stckman2.orientation_lower_arm2,w)
		return cls(( (1-w)*stckman1.position[0] + w * stckman2.position[0], (1-w)*stckman1.position[1] + w * stckman2.position[1]), orientation_leg1,orientation_lower_leg1, orientation_leg2, orientation_lower_leg2,
			orientation_arm1, orientation_lower_arm1, orientation_arm2, orientation_lower_arm2)
