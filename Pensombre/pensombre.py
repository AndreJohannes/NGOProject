...
class OneThought:
    def __init__(self, startTime, image, pos_x):
        self.bubble1 = Tools.MovingBubble(pos_x, 163, 10, startTime, startTime + 20)
        ...
        self.rectangualar = Tools.MorphingTextBox(image, 977, 139, 20, startTime + 20, True)
...
dic = {10: 1221, 11: 1196, 12: 1153, 13: 1096, 14: 1022, 15: 952, 16: 874, 17: 797, 18: 724, 19: 646, 20: 562, 21: 476,
       22: 391, 23: 297, 24: 208, 25: 80}

production = True
iOffset = 1000 if production else 0
...
for i in range(0, 150):
    ...
    t = 100
    if (i > t):
        base = Image.open("./images/slider/image" + "{:02d}".format(max(min(i - t, 28), 0)) + ".png")
        if (dic.has_key(i - t)):
            ...
            mask.paste("black", (0, 0, dic[i - t], 720))
