    ...
    for node in parent.children:
        if node.has_leave:
            ...
            for i in range(0, 66):
                ...
                d.ellipse(
                    (dx + 349 + 1.3 * node._absolut_position[0] - 5, dy + 96 + 1.3 * node._absolut_position[1] - 5,
                     dx + 349 + 1.3 * node._absolut_position[0] + 5, dy + 96 + 1.3 * node._absolut_position[1] + 5), p,
                    b)
            d.flush()
